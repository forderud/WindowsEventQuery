...
Example query for displaying the last 5 events of either "Critical(1)" or "Error(2)" level in the "System" log, sorted  from newest to oldest: `wevtutil qe "System" /q:"*[*/Level <= 2]" /c:5 /rd:true /f:text`
